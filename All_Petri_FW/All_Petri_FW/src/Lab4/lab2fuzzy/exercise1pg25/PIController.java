...
public class PIController {
	...
	pn.SetInputFile("D:\\All_Petri_FW_IntelliJ_N\\All_Petri_FW\\All_Petri_FW\\src\\Lab4\\Lab2Fuzzy\\Ex1Page25\\PIController.txt"); //for testing PI controller alone, put initial marking in p2 and p4, T7 must all be commented
	...
	// T1 ------------------------------------------------
			...
			input3.add(new PlaceNameWithWeight("P5", 0.1F));
			...
			input5.add(new PlaceNameWithWeight("P8", 0.9F));
