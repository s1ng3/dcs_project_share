...
public class PIController {
	...
	pn.SetInputFile("D:\\All_Petri_FW_IntelliJ_N\\All_Petri_FW\\All_Petri_FW\\src\\Lab4\\Lab2Fuzzy\\Ex3Page25\\PIController.txt"); //for testing PI controller alone, put initial marking in p2 and p4, T7 must all be commented
...
// T8 ------------------------------------------------
			...
			input8.add(new PlaceNameWithWeight("P6", 1F));
...
// T9 ------------------------------------------------
			...
			input7.add(new PlaceNameWithWeight("P7", 1F));
			input7.add(new PlaceNameWithWeight("P13", 0.2F));

			ArrayList<String> Output7 = new ArrayList<>();
			Output7.add("P14");


			grdT3.Activations.add(new Activation(t3, adder, input7, TransitionOperation.FLRS, Output7));
