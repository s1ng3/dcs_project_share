...
public class HTC {
	...
	// T1 ------------------------------------------------
			...
			t4.InputPlaceName.add("P10");

			Condition T4Ct1 = new Condition(t4, "P10", TransitionCondition.NotNull);
			...
			input4.add(new PlaceNameWithWeight("P10", 1.2F));
		...
		input6.add(new PlaceNameWithWeight("P9", 1F));
